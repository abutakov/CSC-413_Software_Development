...
public class Parser {
    ...
    private EnumSet<Tokens> relationalOps =
            EnumSet.of(Tokens.Equal, Tokens.NotEqual, Tokens.Less, Tokens.LessEqual, Tokens.Greater);
    ...
    //******
    private java.lang.Integer i; //aditional line traking
    private int iVal = 0;
    ...
    public AST rStatement() throws SyntaxError {
        ...
        if (isNextTok(Tokens.Return)) {
            ...
            if (isNextTok(Tokens.SemiColon)) {  // if return; then just return the empty ReturnTree, you will not
                //t.addKid(new VoidTypeTree());
                scan();
                return t;                     //be adding any expresions to the tree. there are no expressions.
            }

            t.addKid(rExpr());
            return t;
        }
//        if(isNextTok(Tokens.Identifier)){  //then it must be a funciton call
//            t= new CallTree();
//            
//            
//            
    ...
    private void scan() {
        ...
        if (currentToken != null) {
            ...
            if (i > iVal) {
                ...
                System.out.print(i.toString() + ". " + lex.getListElement(i - 1) + "\n");
